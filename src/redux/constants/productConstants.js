...
export const GET_CATEGORYPRODUCTS_REQUEST = "GET_PRODUCTS_REQUEST";
export const GET_CATEGORYPRODUCTS_SUCCESS = "GET_PRODUCTS_SUCCESS";
export const GET_CATEGORYPRODUCTS_FAIL = "GET_PRODUCTS_FAIL";
